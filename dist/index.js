(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('rxjs'), require('rxjs/operators')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'rxjs', 'rxjs/operators'], factory) :
  (factory((global.ReactX = {}),global.React,global.rxjs,global.rxjs.operators));
}(this, (function (exports,React,rxjs,operators) { 'use strict';
  ...
  function reactive(propsMapper) {
      return function (WrappedComponent) {
          ...
          return _temp = _class = function (_Component) {
              inherits(ReactiveWrapper, _Component);
              ...
              ReactiveWrapper.prototype.componentDidMount = function componentDidMount() {
                  ...
                  var deltaProps$ = propsMapper(props$).pipe(operators.filter(isObject), operators.scan(function (acc, delta) {
              ...
              ReactiveWrapper.prototype.render = function render() {
                  return React__default.createElement(WrappedComponent, this.state);
              };
